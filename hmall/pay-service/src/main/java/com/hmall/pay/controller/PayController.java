...
public class PayController {
    ...
    @ApiOperation("超时未支付或取消订单，修改支付状态")
    @PutMapping("/{orderId}")
    public void cancelPayOrderByBizOrderNo(@PathVariable("orderId") Long orderId) {
        payOrderService.cancelPayOrderByBizOrderNo(orderId);
    }
}
